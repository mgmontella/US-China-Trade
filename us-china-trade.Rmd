...
# This data frame will provide the line graph with year  # on the x-axis and millions of USD on the y-axis, with two lines representing either import or export. Users will  # select the type of service they want to see the distinction for.
...
# using this to look for issues with df
